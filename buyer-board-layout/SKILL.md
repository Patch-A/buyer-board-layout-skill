...
3. Map input buyer/company data into the required fields.
4. Insert buyer logos and official website or brand visuals with separate sourcing logic.
5. Export a finished PPT and, when useful, slide preview images.
...
- Keep the footer `AI footer note`.
...
Write or update a reusable rule file before trying to mass-produce pages. Use `references/buyer-board-rules.md` as the durable summary.
...
2. Official project/brand image.
...
1. Generate a text-only PPT from the approved template.
2. Apply image replacement and export final PPT plus previews.
...
- `scripts/fill_buyer_board_text.py`
  Use when generating the text-only PPT layer from a template and structured buyer data.
